        ...
        return new es6_promise_1.Promise((resolve, reject) => {
            ...
            if (this._connected && typeof jsonPathValues[0] !== 'undefined') {
                ...
                if (Array.isArray(jsonPathValues[0])) {
                    ...
                    this.setLastRejection(new rejection_dfdb_1.Rejection(rejection_codes_dfdb_1.RejectionCodes.NotIndexableValue));
                ...
                this.setLastRejection(new rejection_dfdb_1.Rejection(rejection_codes_dfdb_1.RejectionCodes.IndexNotConnected));
                reject(this._lastRejection);
            }
            else {
                //
