    ...
    createBasics() {
        ...
        return new es6_promise_1.Promise((resolve, reject) => {
            ...
            zip.generateNodeStream({ type: 'nodebuffer', streamFiles: true })
                ...
                .on('error', (error) => {
                this._mainObject.setLastRejection(new rejection_dfdb_1.Rejection(rejection_codes_dfdb_1.RejectionCodes.InvalidDBPath, error));
        ...
        return new es6_promise_1.Promise((resolve, reject) => {
            ...
            fs.readFile(this._mainObject._dbFullPath, (error, data) => {
                ...
                if (error) {
                    //
                    // Rejecting promise.
                    this._mainObject.setLastRejection(new rejection_dfdb_1.Rejection(rejection_codes_dfdb_1.RejectionCodes.DatabaseNotValid, { error, path: this._mainObject._dbFullPath }));
                    reject(this._mainObject._lastRejection);
                }
                else {
                    //
