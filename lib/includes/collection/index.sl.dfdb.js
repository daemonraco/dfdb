...
class IndexSubLogic extends sub_logic_dfdb_1.SubLogic {
    //
    // Public methods.
    /**
    ...
    addFieldIndex(name) {
        ...
        return new es6_promise_1.Promise((resolve, reject) => {
            ...
            if (this._mainObject._connected && typeof this._mainObject._indexes[name] === 'undefined') {
                ...
                this._mainObject.setLastRejection(new rejection_dfdb_1.Rejection(rejection_codes_dfdb_1.RejectionCodes.DuplicatedIndex, { index: name }));
                reject(this._mainObject._lastRejection);
            }
        });
    }
    ...
    rebuildFieldIndex(name) {
        ...
        return new es6_promise_1.Promise((resolve, reject) => {
            ...
            if (this._mainObject._connected && typeof this._mainObject._indexes[name] !== 'undefined') {
                ...
                this._mainObject.setLastRejection(new rejection_dfdb_1.Rejection(rejection_codes_dfdb_1.RejectionCodes.UnknownIndex, { index: name }));
                reject(this._mainObject._lastRejection);
            }
        });
    }
...
exports.IndexSubLogic = IndexSubLogic;
