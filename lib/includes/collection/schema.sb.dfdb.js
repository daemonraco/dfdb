...
class SchemaSubLogic extends sub_logic_dfdb_1.SubLogic {
    //
    // Public methods.
    /**
            ...
            if (this._mainObject._connected) {
                ...
                if (schemaMD5 !== this._mainObject._manifest.schemaMD5) {
                    ...
                    if (valid) {
                        ...
                        steps.push({ params: {}, stepFunction: (params) => this._mainObject.rebuildAllIndexes(params) });
                        //
                        // Loading everything.
...
exports.SchemaSubLogic = SchemaSubLogic;
