...
class Collection {
    ...
    constructor(name, connection) {
        ...
        //
        // Sub-logics.
        this._subLogicCRUD = new crud_sl_dfdb_1.CRUDSubLogic(this);
        this._subLogicFind = new find_sl_dfdb_1.FindSubLogic(this);
        this._subLogicIndex = new index_sl_dfdb_1.IndexSubLogic(this);
        this._subLogicSchema = new schema_sl_dfdb_1.SchemaSubLogic(this);
        this._subLogicSearch = new search_sl_dfdb_1.SearchSubLogic(this);
    }
    //
    // Public methods.
    /**
