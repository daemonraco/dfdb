...
class CRUDSubLogic extends sub_logic_dfdb_1.SubLogic {
    //
    // Public methods.
    /**
    ...
    insert(doc) {
        ...
        return new es6_promise_1.Promise((resolve, reject) => {
            ...
            if (typeof doc !== 'object' || Array.isArray(doc)) {
                this._mainObject.setLastRejection(new rejection_dfdb_1.Rejection(rejection_codes_dfdb_1.RejectionCodes.DocIsNotObject));
                ...
                if (this._mainObject._subLogicSchema.hasSchema()) {
                    ...
                    if (this._mainObject._schemaValidator(doc)) {
                        ...
                        this._mainObject.setLastRejection(new rejection_dfdb_1.Rejection(rejection_codes_dfdb_1.RejectionCodes.SchemaDoesntApply, `'\$${this._mainObject._schemaValidator.errors[0].dataPath}' ${this._mainObject._schemaValidator.errors[0].message}`));
                    }
                }
                //
    ...
    partialUpdate(id, partialDoc) {
        ...
        return new es6_promise_1.Promise((resolve, reject) => {
            ...
            if (typeof partialDoc !== 'object' || Array.isArray(partialDoc)) {
                ...
                this._mainObject.setLastRejection(new rejection_dfdb_1.Rejection(rejection_codes_dfdb_1.RejectionCodes.DocNotFound));
                reject(this._mainObject._lastRejection);
            }
            else if (!this._mainObject._connected) {
                this._mainObject.setLastRejection(new rejection_dfdb_1.Rejection(rejection_codes_dfdb_1.RejectionCodes.CollectionNotConnected));
...
exports.CRUDSubLogic = CRUDSubLogic;
